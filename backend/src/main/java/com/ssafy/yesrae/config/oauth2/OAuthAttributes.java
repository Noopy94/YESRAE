package com.ssafy.yesrae.config.oauth2;

import com.ssafy.yesrae.config.oauth2.userinfo.GoogleOAuth2UserInfo;
import com.ssafy.yesrae.config.oauth2.userinfo.KakaoOAuth2UserInfo;
import com.ssafy.yesrae.config.oauth2.userinfo.NaverOAuth2UserInfo;
import com.ssafy.yesrae.config.oauth2.userinfo.OAuth2UserInfo;
...
public class OAuthAttributes {
     ...
     * socialId(식별값), nickname, imageUrl을 가져와서 build email에는 UUID로 중복 없는 랜덤 값 생성 role은 GUEST로 설정
     */
